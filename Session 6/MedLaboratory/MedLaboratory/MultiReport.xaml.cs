                    ...
                    switch (userData.idReport)
                    {
                        ...
                        case 2:
                            ...
                            if (saveFileDialog1.ShowDialog() == true)
                            {
                                ...
                                PdfWriter writer1 = PdfWriter.GetInstance(doc1, new FileStream($@"{saveFileDialog1.FileName}", FileMode.Create));
                        ...
                        case 3:
                            ...
                            saveFileDialog4.Filter = "PDF files (*.pdf)|*.pdf";
                            if (saveFileDialog4.ShowDialog() == true)
                            {
                                Document doc4 = new Document();
                                PdfWriter writer4 = PdfWriter.GetInstance(doc4, new FileStream($@"{saveFileDialog4.FileName}", FileMode.Create));
                                doc4.SetPageSize(PageSize.A4.Rotate());

                                BaseFont baseFont4 = BaseFont.CreateFont("C:\\Windows\\Fonts\\arial.ttf", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
                                Font font4 = new Font(baseFont4, 12);

                                doc4.Open();
                                PdfPTable table1 = new PdfPTable(4);

                                table1.AddCell(new Paragraph("Код услуги", font4));
                                table1.AddCell(new Paragraph("Услуга", font4));
                                table1.AddCell(new Paragraph("Материал", font4));
                                table1.AddCell(new Paragraph("Количество", font4));

                                foreach (var item in report2)
                                {
                                    table1.AddCell(new Paragraph(item.Код_услуг.ToString(), font4));
                                    table1.AddCell(new Paragraph(item.Услуга.ToString(), font4));
                                    table1.AddCell(new Paragraph(item.Материал.ToString(), font4));
                                    table1.AddCell(new Paragraph(item.Количество.ToString(), font4));
                                }
                        ...
                        case 4:
                            ...
                            saveFileDialog3.Filter = "PDF files (*.pdf)|*.pdf";
                            if (saveFileDialog3.ShowDialog() == true)
                            {
                                Document doc2 = new Document();
                                PdfWriter writer2 = PdfWriter.GetInstance(doc2, new FileStream($@"{saveFileDialog3.FileName}", FileMode.Create));
